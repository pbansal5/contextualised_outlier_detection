...
class NN_Janta(nn.Module):
    def __init__(self):

        super(NN_Janta, self).__init__()
        ...
        self.feat_info = [["time",'categ',130],['pulocation','categ',76],['dolocation','categ',28]]
        self.size_input = feats*50
        self.size_output = 1
...
class Dataset_(torch.utils.data.Dataset):
    ...
    def __getitem__(self,index):
        ...
        left = self.feats[:time_,shop_,prod_]
        left = self.feats[time_+1:,shop_,prod_]
