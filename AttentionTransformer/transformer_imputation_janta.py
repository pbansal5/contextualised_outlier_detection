...
log_file = 'experimental_transformer_janta_allembeddings_smaller'
...
model = OurModel(sizes=[130,76,28],embedding_size=32).to(device)
...
max_epoch = 200
start_epoch = 0
iteration = (start_epoch*len(train_set))/batch_size
