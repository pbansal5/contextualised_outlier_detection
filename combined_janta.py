...
train_set = Proposal1Dataset_('dataset/jantahack_complete.npy','dataset/jantahack_train_examples.npy')
val_set3 = Proposal1Dataset_('dataset/jantahack_complete.npy','dataset/jantahack_test_examples.npy')
update_set = Proposal1Dataset_('dataset/jantahack_complete.npy','dataset/janta_all_examples.npy')
