...
class VAE(nn.Module):
    def __init__(self):
        ...
        self.feat_info = [['feat_%d'%i,'real',1] for i in range(feats)]#[["time",'categ',34],['shop','categ',60],['prod','categ',84],['cnt','real',1]]
        self.feat_info.append(['cnt','real',1])
        self.size_input = feats+1
        ...
        self.logvar_x = nn.Parameter(torch.zeros(1,feats+1).float())
